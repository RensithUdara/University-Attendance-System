...
<div class="dashboard-container">
    ...
    <div class="welcome-section animate-fade-in">
        <div class="row align-items-center">
            <div class="col">
                <h2 class="welcome-title">Edit Course: {{ $course->name }} 📝</h2>
                <p class="welcome-subtitle">Update course information and details</p>
            </div>
            <div class="col-auto">
        ...
        <div class="col-12">
            <div class="dashboard-card animate-fade-in-up" style="animation-delay: 0.2s">
                <div class="card-header">
                    <h3 class="card-title">
                        <i class="fas fa-edit me-2"></i>Edit Course: {{ $course->name }}
                    </h3>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-control @error('semester') is-invalid @enderror" 
                                                ...
                                                @foreach($semesters as $key => $value)
                                                    <option value="{{ $key }}" {{ old('semester', $course->semester) == $key ? 'selected' : '' }}>
                                                        {{ $value }}
                                                    </option>
                                                @endforeach
                                            </select>
