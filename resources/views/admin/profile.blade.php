    ...
    <div class="row">
            ...
            <div class="dashboard-card animate-fade-in-up" style="animation-delay: 0.2s">
                ...
                <div class="card-body text-center">
                    <div class="profile-picture-section">
                        <div class="profile-avatar-large admin-avatar mb-3">
                        ...
                        <form action="{{ route('admin.profile.picture') }}" method="POST" enctype="multipart/form-data" class="mt-4">
                            @csrf
                            <div class="mb-3">
                        ...
                        @if(Auth::user()->profile_picture)
                        <form action="{{ route('admin.profile.picture.remove') }}" method="POST" class="mt-2">
                            @csrf
                ...
                <div class="card-body">
                    <div class="account-stats">
                        ...
                        <div class="stat-item">
                            ...
                            <div class="stat-info">
                                <div class="stat-value">Last Login</div>
                                <div class="stat-label">{{ Auth::user()->last_login_at ? Auth::user()->last_login_at->format('M d, Y h:i A') : 'N/A' }}</div>
                            </div>
                        </div>
                        <div class="stat-item">
        ...
        <div class="col-lg-8">
            ...
            <div class="dashboard-card animate-fade-in-up" style="animation-delay: 0.6s">
                <div class="card-header">
                    <h3 class="card-title">
                        <i class="fas fa-cogs me-2"></i>Account Preferences
                    </h3>
                </div>
                <div class="card-body">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-control" name="theme">
                                        ...
                                        <option value="auto" {{ Auth::user()->theme === 'auto' ? 'selected' : '' }}>Auto (System)</option>
                                    </select>
                                </div>
                            </div>
                        </div>
...
.profile-avatar-large.admin-avatar {
