            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-3 mb-3">
                            <button class="btn btn-warning btn-block" data-bs-toggle="modal" data-bs-target="#quickAddModal">
        ...
        <div class="col-12">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Quick Add Users & Courses</h6>
                </div>
                <div class="card-body">
                    <div class="row">
                        <!-- Add Student Card -->
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Add New Student</div>
                                            <p class="text-muted mb-3">Create a new student account</p>
                            ...
                            <div class="card border-left-success h-100">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                Add New Lecturer</div>
                                            <p class="text-muted mb-3">Create a new lecturer account</p>
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">
                                                Add New Course</div>
                                            <p class="text-muted mb-3">Create a new course</p>
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                                Enroll Students</div>
                                            <p class="text-muted mb-3">Enroll students in courses</p>
                                            <a href="{{ route('enrollments.index') }}" class="btn btn-warning">
                                                <i class="fas fa-clipboard-list me-1"></i> Manage Enrollments
                                            </a>
                                        </div>
                                        <div class="col-auto">
